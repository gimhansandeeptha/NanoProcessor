...
set_property PACKAGE_PIN U2 [get_ports {Anode_sig[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_sig[0]}]
set_property PACKAGE_PIN U4 [get_ports {Anode_sig[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_sig[1]}]
set_property PACKAGE_PIN V4 [get_ports {Anode_sig[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_sig[2]}]
set_property PACKAGE_PIN W4 [get_ports {Anode_sig[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Anode_sig[3]}]
